...
import farmIcon1 from "/project/enduser/src/public/cocofarm6.png"
    ...
    <div className="flex container h-[70px] text-black font-bold border-b-2 mt-2">
      ...
      <div className="flex justify-between">
        ...
        <div className="w-[800px]  flex justify-center">
          ...
          <div className="m-5 mb-3 mt-auto text-xl hover:underline">
            <Link to={"/farmer/home"}>Home</Link>
          </div>

          <div className="m-5 ml-20 mb-3 mt-auto text-xl hover:underline">
